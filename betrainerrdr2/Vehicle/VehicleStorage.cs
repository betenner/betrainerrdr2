...
namespace BETrainerRdr2.Vehicle
{
    ...
    public static class VehicleStorage
    {
        ...
        //    Utils.CSML("Emergency and Military", "特種車輛與軍車"), 
        //    Utils.CSML("Motorcycles", "摩托車"), 
        //    Utils.CSML("Planes", "飛機"), 
        //    Utils.CSML("Helicopters", "直升機"), 
        //    Utils.CSML("Boats", "船隻"), 
        //    Utils.CSML("Bicycles", "自行車"),
        //};
        ...
        //    new MLString[] 
        //    { 
        //        Utils.CSML("Supercars", "超級跑車"), 
        //        Utils.CSML("Sports", "跑車"), 
        //        Utils.CSML("Sport Classics", "經典跑車"), 
        //        Utils.CSML("Coupes", "房車"), 
        //        Utils.CSML("Muscle", "肌肉車"), 
        //        Utils.CSML("Offroad", "越野車") ,
        //        Utils.CSML("SUVs", "SUV"), 
        //        Utils.CSML("Sedans", "轎車"), 
        //        Utils.CSML("Compacts", "緊湊型車"),
        //    },
        //    new MLString[] 
        //    { 
        //        Utils.CSML("Pickups", "皮卡"), 
        //        Utils.CSML("Vans", "廂式貨車"), 
        //        Utils.CSML("Trucks", "卡車"), 
        //        Utils.CSML("Service/Utility", "服務車/工具車"), 
        //        Utils.CSML("Trailers", "拖車"), 
        //        Utils.CSML("Trains (Undriveable)" , "火車(不可駕駛)"),
        //    },
        //};
